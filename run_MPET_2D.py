...
def run_MPET_2D_AbsoluteInflow_RigidMotion():

    ymlFile = open("configurations/2D_3MPET_AbsAPB_RigidMotion.yml") 
    parsedValues = yaml.load(ymlFile, Loader=yaml.FullLoader)
    materialParameters = parsedValues['material_parameters']
    settings = parsedValues['solver_settings']
    sourceParameters = parsedValues['source_data']
...
def run_MPET_2D_RelativeInflow_RigidMotion():

    ymlFile = open("configurations/2D_3MPET_RelAPB_RigidMotion.yml") 
    parsedValues = yaml.load(ymlFile, Loader=yaml.FullLoader)
    materialParameters = parsedValues['material_parameters']
    settings = parsedValues['solver_settings']
    sourceParameters = parsedValues['source_data']
...
if __name__ == "__main__":
    run_MPET_2D_AbsoluteInflow_RigidMotion()
    #run_MPET_2D_RelativeInflow_RigidMotion()
